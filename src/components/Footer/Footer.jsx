      ...
      <div className="flex flex-wrap  gap-y-12 max-w-[1400px] mx-auto px-10">
        <div className="flex-1 basis-[300px]">
          ...
          <p className="text-zinc-600 mt-6 max-w-[350px]">
            we’re here to serve you with quality, flavor, and care. Fresh
            ingredients, bold flavors, and unforgettable experiences – that's
            our promise.
          </p>
        ...
        <div className="flex-1">
          ...
          <p className="mt-6 text-zinc-600">
            Questions or Feedback? <br /> we'd love to heart from you.
          </p>
